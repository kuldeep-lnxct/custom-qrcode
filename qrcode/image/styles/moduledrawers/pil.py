...
class SquareModuleDrawer(StyledPilQRModuleDrawer):
    ...
    def drawrect(self, box, is_active: bool, point_type=None, row=None, col=None):
        if is_active:
...
class RoundedModuleDrawer(StyledPilQRModuleDrawer):
    ...
    def drawrect(self, box: list[list[int]], is_active: "ActiveWithNeighbors", point_type=None, row=None, col=None):
        if not is_active:
            return
        # find rounded edges
...
class VerticalBarsDrawer(StyledPilQRModuleDrawer):
    ...
    def drawrect(self, box, is_active: "ActiveWithNeighbors", point_type=None, row=None, col=None):
        if is_active:
            # find rounded edges
